...
### Population is people, and hardship takes a share

**Population is people, and hardship takes a share.** A town counts people in
whole numbers — thousands of them. Famine, shortage and war each take a share of
the people they fall on, in one event that says how many. See
`docs/mechanics/population.md`.

**Workers go before experts, always.** An expert is lost only when no worker
